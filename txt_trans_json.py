...
coco_format_save_path='/root/autodl-tmp/yolov10-MNV4/PCB_resize0.8_0.8/PCB_label_json'   #要生成的标准coco格式标签所在文件夹
yolo_format_classes_path='/root/autodl-tmp/yolov10-MNV4/classes.txt'     #类别文件，一行一个类
yolo_format_annotation_path='/root/autodl-tmp/yolov10-MNV4/PCB_resize0.8_0.8/labels'  #yolo格式标签所在文件夹
img_pathDir='/root/autodl-tmp/yolov10-MNV4/PCB_resize0.8_0.8/images'    #图片所在文件夹
...
write_json_context['info']= {'description': '', 'url': '', 'version': '', 'year': 2024, 'contributor': 'bluegravitys', 'date_created': '2024-09-24'}
