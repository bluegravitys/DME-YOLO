...
if __name__ == '__main__':
    model = YOLO('D:\\yolov10-MNV4\\ultralytics\\cfg\\models\\v10\\yolov10n_ODConv.yaml')
    ...
    model.load('D:\\yolov10-MNV4\\yolov10n.pt') # 是否加载预训练权重,科研不建议大家加载否则很难提升精度
    model.train(
        data=r"D:\\yolov10-MNV4\\PCB_remake.yaml",
